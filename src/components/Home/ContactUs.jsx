  ...
  const contactItems = [
    {
      Icon: LocationIcon,
      label: 'Address',
      content: '23, Bhanushali bldg, 1st floor, room no:4, 3rd Panjarapole Lane, Near Gulalwadi Circle, Mumbai:400004'
    },
    {
      Icon: PhoneIcon,
      label: 'Phone',
      content: ['+91 98209 55550', '+91 88793 38852']
    },
    {
      Icon: EnvelopeIcon,
      label: 'Email',
      content: 'sales@jainamferroalloys.com'
    },
    {
      Icon: ClockIcon,
      label: 'Working Hours',
