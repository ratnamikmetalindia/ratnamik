        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div className="flex flex-col py-3">
              ...
              <Link href="/catalog" onClick={(e) => handleNavClick(e, '/catalog')} className="flex items-center px-6 py-3 text-lg font-medium tracking-wide text-gray-800 hover:text-[#075ca6] hover:bg-gray-100 transition-colors">Catalog</Link>
