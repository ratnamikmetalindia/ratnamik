...
const PremiumBulletIcon = () => (
  ...
  >
    ...
    />
    <path
      d="M10 16.4L6 12.4L7.41 10.99L10 13.57L16.59 6.98L18 8.4L10 16.4Z"
      fill="url(#paint0_linear)"
    />
    <defs>
      <linearGradient
...
const productsDatabase = {
  1: {
    ...
    specs: [
      {
        parameter: "Material Grades",
        specification:
          "Stainless Steel, Carbon Steel, Alloy Steel, Duplex, Super Duplex, Nickel Alloys, Copper Alloys",
      },
      { parameter: "Size Range", specification: '1/8" NB to 48" NB' },
      {
        parameter: "Pressure Class",
        specification: "150, 300, 600, 900, 1500, 2500 LBS",
      },
      { parameter: "Face Type", specification: "RF, FF, RTJ" },
      {
        parameter: "Standards",
        specification: "ANSI B16.5, B16.47, MSS SP44, DIN, BS, EN",
      },
      {
        parameter: "Testing",
        specification:
          "Pitting Resistance, Chemical Analysis, Hardness, Micro/Macro, Flaring, Flattening",
      },
    ],
    gallery: [
      "./images/flangs/SLIP ON FLANGES/CS_Slip_On_Flanges.jpg",
      "./images/flangs/SLIP ON FLANGES/SS_SLIP_ON_FLANGES.jpeg",
      "./images/flangs/SLIP ON FLANGES/Alloy-Steel-Slip-On-Flanges.webp",
    ],
    productFeatures: [
  ...
  2: {
    ...
    specs: [
      ...
      {
        parameter: "Standards",
        specification: "ASME B16.5, ASME B16.47, MSS SP44, DIN, BS, EN",
      },
      {
        parameter: "Testing",
        specification:
  ...
  4: {
    ...
    specs: [
      ...
      {
        parameter: "Standards",
        specification: "ANSI B16.5, ANSI B16.47, MSS SP44, AWWA, DIN, BS, EN",
      },
      {
        parameter: "Testing",
        specification:
  ...
  5: {
    ...
    specs: [
      ...
      {
        parameter: "Standards",
        specification: "ANSI B16.5, ANSI B16.47, MSS SP44, DIN, BS, EN, AWWA",
      },
      {
        parameter: "Testing",
        specification:
  ...
  8: {
    ...
    specs: [
      {
        parameter: "Standard",
        specification:
          "ANSI 16.47, ANSI B16.5, MSS SP44, AWWA, API-605, DIN2527, DIN2573, DIN2641, DIN2632, DIN2637, DIN2673",
      },
      { parameter: "Dimensions", specification: "DIN Flanges" },
      {
        parameter: "Class",
        specification:
          "150, 300, 600, 900, 1500, 2500 LBS, ND-6, ND-10, ND-16, ND-25, ND-40",
      },
      ...
      { parameter: "Face Type", specification: "FF, RF, RTJ" },
      {
        parameter: "Testing",
        specification:
          "Hardness, Chemical Composition, Flaring, Flattening, Radiography, Third Party Inspection",
      },
    ],
    gallery: [
    ...
    otherTypes: [
      ...
      "SS DIN Flanges",
      "DIN Slip On Flanges",
      "DIN PN6 Flat Face Flanges",
      "DIN Ring Joint Flanges",
      "ASTM / ASME DIN Flanges",
      "ANSI DIN Flanges",
      "BS DIN Flanges",
      "Steel DIN Flanges",
      "Monel DIN Flanges",
      "DIN Stainless Steel Flanges",
      "Hastelloy DIN Flanges",
      "Aluminum DIN Flanges",
      "EN DIN Flanges",
      "Forged Steel DIN Flanges",
      "DIN Threaded Flanges",
  ...
  9: {
    ...
    specs: [
      ...
      {
        parameter: "Standards",
        specification: "ANSI B16.5, ANSI B16.47 A&B, MSS SP44, AWWA, API 605",
      },
      { parameter: "Size", specification: '1/8" NB to 48" NB' },
      {
        parameter: "Class",
      ...
      },
      {
        parameter: "Testing",
        specification:
          "Hardness, Pitting Resistance, Flattening, Flaring, Macro/Micro, Chemical, Mechanical, Hydrostatic, Radiography",
      },
    ],
    gallery: [
    ...
    otherTypes: [
      ...
      "Paddle Flanges",
      "Paddle Blank Flanges",
      "ASTM A515 Paddle Blind Flanges",
      "Paddle Spacer Flanges",
      "Hydrotest Flanges",
      "Hydro Blinds Flanges",
      "Blind Rack Flanges",
      "Blind Flanges",
      "Slip Blinds Flanges",
      "DIN Paddle Blind Flanges",
      "Hastelloy Paddle Blind Flanges",
      "Spectacle Blind Flanges",
      "BS Paddle Blind Flanges",
      "EN Spectacle Blind Flanges",
      "Forged Steel Paddle Blind Flanges",
      "DIN Paddle Blind Flanges Exporter",
    ],
  },
  10: {
    id: "product10",
    ...
    otherTypes: [
      "Paddle Spacer Flanges",
      "Spacer Flanges",
      "Spacer Blind Flanges",
      "ASTM A515 Paddle Spacer Flanges",
      "Hydro Blinds Flanges",
      "Blind Rack Flanges",
      "Blind Flanges",
      "Paddle Flanges",
      "DIN Spacer Flanges",
      "Hastelloy Paddle Spacer Flanges",
      "Spectacle Spacer Flanges",
      "BS Paddle Spacer Flanges",
      "EN Paddle Spacer Flanges",
      "Forged Steel Paddle Spacer Flanges",
      "DIN Paddle Spacer Flanges Exporter",
      "Paddle Spacer Flanges Stockist",
    ],
  },
  11: {
    id: "product11",
    ...
    specs: [
      ...
      },
      {
        parameter: "Class",
        specification:
          "150, 300, 600, 900, 1500, 2500 LBS, ASA 150#, 2.0MPa, 5.0MPa, 10.0MPa, 15.0MPa, 25.0MPa, 42.0MPa",
      },
      ...
      { parameter: "BS", specification: "BS4504, BS1560, BS10" },
      {
        parameter: "Testing",
        specification:
          "PMI/IGC, Flattening, Flaring, Hardness, Macro/Micro, Mechanical/Chemical, Radiography, Hydrostatic",
      },
    ],
    gallery: [
      "./images/flangs/SPECTACLE BLIND FLANGES/SPECTACLE BLIND FLANGES.jpg",
    ...
    otherTypes: [
      "Spectacle Blind Flanges",
      "Spectacle Flanges",
      "ASTM A182 Spectacle Flanges",
      "SS Spectacle Blind Flanges",
      "CS Spectacle Blind Flanges",
      "Alloy Steel Spectacle Blind Flanges",
      "Duplex Steel Spectacle Blind Flanges",
      "Super Duplex Steel Spectacle Blind Flanges",
      "Nickel Alloys Spectacle Blind Flanges",
      "Alloy 20 Spectacle Blind Flanges",
      "Spectacle Blind Flanges Exporter",
      "Spectacle Flanges Stocks",
      "Forged Steel Spectacle Blind Flanges",
      "DIN Spectacle Blind Flanges Exporter",
      "Spectacle Blind Flanges Stockist",
      "Blind Flanges Distributors",
    ],
  },
  12: {
    id: "product12",
    ...
    specs: [
      {
        parameter: "Standards",
        specification: "ANSI, MSS, API, AWWA, DIN, JIS, BS, GB",
      },
      {
        parameter: "Class",
        specification: "150#, 300#, 400#, 600#, 900#, 1500#, 2500#",
      },
      { parameter: "Size", specification: '1/8" to 84" NB' },
      {
        parameter: "Material",
        specification:
          "Carbon Steel, Stainless Steel, Alloy Steel, Nickel Alloys, Duplex Steel, Titanium, Copper Alloys",
      },
      { parameter: "Type", specification: "Threaded, Slip-On, Welding Neck" },
      {
        parameter: "Testing",
        specification:
          "Mechanical/Chemical, Flattening, Flaring, Hardness, Radiography, Hydrostatic",
      },
    ],
    gallery: [
      "./images/flangs/RING TYPE JOINT FLANGES/CS Ring Type Joint Flanges.jpg",
    ...
    otherTypes: [
      ...
      "RTJ Flanges Stockholder",
      "ASTM A182 Ring Type Joint Flanges",
      "Carbon Steel Ring Type Joint Flanges",
      "Alloy Steel RTJ Flanges",
      "AS Ring Type Joint Flanges Exporter",
      "Duplex Steel RTJ Flanges Supplier",
      "Super Duplex Steel RTJ Flanges",
      "Nickel Alloys RTJ Flanges Dealer",
      "Alloy 20 Ring Type Joint Flanges",
      "Ring Type Joint Flanges Exporter",
      "RTJ Flanges Stocks",
      "Forged Steel Ring Type Joint Flanges Supplier",
      "DIN RTJ Flanges Exporter",
      "Ring Type Joint Flanges Stockist",
      "RTJ Flanges Distributors",
    ],
  },
  13: {
    id: "product13",
    ...
    specs: [
      ...
      { parameter: "Size", specification: '1/8" to 84" NB' },
      {
        parameter: "Material",
        specification:
          "Carbon Steel, Stainless Steel, Alloy Steel, Duplex Steel, Nickel Alloys, Titanium, Copper Alloys",
      },
      { parameter: "Type", specification: "Threaded, Slip-On, Welding Neck" },
      {
        parameter: "Testing",
    ...
    otherTypes: [
      "SS Nipo Flanges",
      "Stainless Steel Nipo Flanges",
      "Steel Nipo Flange Stockholder",
      "ASTM A182 Nipo Flange Suppliers",
      "Carbon Steel Nipo Flange Manufacturer",
      "Alloy Steel Nipo Flanges",
      "AS Nipo Flange Exporter",
      "Duplex Steel Nipo Flange Supplier",
      "Super Duplex Steel Nipo Flange",
      "Nickel Alloys Nipo Flange Dealer",
      "Alloy 20 Nipo Flange",
      "Nipo Flange Exporter",
      "Steel Nipo Flange Stocks",
      "Steel Nipo Flange Supplier",
      "Steel Nipo Flange Exporter",
      "Nipo Flange Stockist",
      "Nipo Flanges Distributors",
    ],
  },
  // Buttweld Fittings
  14: {
    ...
    specs: [
      {
        parameter: "Thickness",
        specification: "Schedule 5S – XXS (incl. STD, XS, S20, S40, S80, S160)",
      },
      {
        parameter: "Dimensions",
        specification: "ANSI/ASME B16.9, B16.28, MSS-SP-43",
      },
      {
        parameter: "Size",
        specification: "Seamless: 1/2″–24″, Welded/Fabricated: 1/2″–48″",
      },
      {
        parameter: "Form",
        specification:
          "Equal Tee, Unequal Tee, Reducer Tee, Lateral Tee, Straight Tee",
      },
    ...
    otherTypes: [
      ...
      "ASME/ANSI 16.28 Pipe Tees",
      "SS Pipe Tees Stockholder",
      "ASTM A403 Steel Seamless Lateral Tee Suppliers",
      "Duplex Steel Welded Tees Dealer",
      "Steel Welded Tees Stockholder",
      "ANSI/ASME B16.9 Tee Distributors",
      "Stainless Steel Fitting Tee Manufacturer",
      "ANSI 16.9 Fitting Tee",
      "Nickel Alloy Pipe Tee Exporter",
      "Monel Fitting Tees Supplier",
      "SS Reducing Tee",
      "Duplex Steel Reducing Tee Dealer",
      "Monel Fitting Tees",
      "Hastelloy Fitting Equal Tee Exporter",
      "ANSI B16.28 Reducer Tee Stocks",
      "Alloy 20 Butt weld Tee Supplier",
      "SS Seamless Equal Tee Exporter",
      "Steel Welded Reducing Tee Stockist",
      "Reducing Tee Distributors",
    ],
  },
  15: {
    id: "product15",
    ...
    specs: [
      ...
      {
        parameter: "Form",
        specification: "Concentric Reducer, Eccentric Reducer, Pipe Reducer",
      },
      { parameter: "Type", specification: "Seamless, Welded, Fabricated" },
    ],
    gallery: [
    ...
    otherTypes: [
      ...
      "ASME / ANSI - B 16.9 Reducer",
      "Duplex Steel Eccentric Reducer Dealer",
      "Steel Reducer",
      "Steel Eccentric Reducer Exporter",
      "Carbon Steel Concentric Reducer Stocks",
      "Pipe Reducer Supplier",
      "Concentric Reducer Exporter",
      "Eccentric Reducer Stockist",
      "Reducers Distributors",
      "Buttwelding Fittings MSS SP-75 Reducer Stockiest",
      "Fabricated Buttweld Reducer Suppliers",
      "MSS SP-48 Welded Reducer Dealer",
      "Eccentric Reducer Butt Weld Pipe Fittings Stockholder",
      "Monel Reducer Distributors",
      "Nickel Alloy Pipe Reducer Manufacturer",
      "SS Concentric Reducer",
      "ANSI 16.9 Fitting Reducer Exporter",
      "Alloy Steel Reducer Supplier",
      "Hastelloy Concentric Reducer",
    ],
  },
  16: {
    id: "product16",
    ...
    shortDescription:
      "High-grade stainless steel tubes designed for demanding industrial applications with excellent corrosion resistance and customizable options.",
    image:
    ...
    specs: [
      ...
      {
        parameter: "Industry Use",
        specification: "Pharmaceutical, Chemical, Power Generation, Marine",
      },
    ],
    productFeatures: [
      "Excellent corrosion resistance",
    ...
    specs: [
      {
        parameter: "Materials",
        specification:
          "Stainless Steel, Carbon Steel, Alloy Steel, Nickel Alloy, Duplex & Super Duplex, Copper Nickel",
      },
      {
        parameter: "Standards",
        specification: "ANSI/ASME B16.9, B16.28, MSS-SP-43",
      },
      {
        parameter: "Thickness",
        specification:
          "Sch 5S, 10S, 20S, S10, S20, S30, STD, 40S, S40, S60, XS, 80S, S80, S100, S120, S140, S160, XXS",
      },
      {
        parameter: "Size Range",
        specification: '½" to 24" Seamless, ½" to 48" ERW/Welded/Fabricated',
      },
      {
        parameter: "Form Types",
        specification:
          "Pipe Tee, Equal, Unequal, Lateral, Straight, Reducer, Seamless, Welded",
      },
    ],
    productFeatures: [
      "ISO 9001:2015 certified manufacturing",
  ...
  18: {
    ...
    shortDescription:
      "High precision 5D and 6D pipe bends manufactured with induction bending technology offering smooth flow, corrosion resistance, and durability for industrial and petrochemical applications.",
    ...
    specs: [
      ...
      {
        parameter: "Stainless Steel Grades",
        specification:
          "ASTM A403 WP grades 304, 304L, 316, 316L, 317, 321, 310, 347, 904L",
      },
      {
        parameter: "Carbon Steel Grades",
        specification:
          "ASTM A234 WPB, A420 WPL3, A420 WPL6, MSS-SP-75 WPHY 42-70",
      },
      {
        parameter: "Standards",
        specification:
          "ASTM A403, ASME SA403, ANSI B16.9, ASME B16.25, ASME B16.28, MSS-SP-43",
      },
  ...
  19: {
    ...
    shortDescription:
      "Premium ASTM A403 standard stainless steel reducing tees designed for efficient piping with high impact strength, corrosion resistance, and turbulence-free flow.",
    ...
    specs: [
      ...
      {
        parameter: "Alloy Steel Grades",
        specification: "ASTM A234 WP1, WP5, WP9, WP11, WP22, WP91",
      },
      {
        parameter: "Nickel Alloy Grades",
        specification:
          "UNS 2200, UNS 2201, Monel 400, Alloy 20, Inconel 600/601/625/825, Hastelloy C276",
      },
      {
        parameter: "Duplex & Super Duplex",
        specification: "ASTM A815, ASME SA815 UNS S31803, S32205",
      },
      ...
      {
        parameter: "Size Range",
        specification: '½" to 24" Seamless, ½" to 48" Welded/Fabricated',
      },
    ],
    productFeatures: [
  ...
  slug: "stub-end",
  shortDescription:
    "A pipe fitting used to connect pipes with lap joint flanges, allowing easy disassembly and providing a secure, leak-proof connection in piping systems.",
  image: "./products/Buttweld Fittings/stub-end.jpg",
  gallery: [
    "./products/Buttweld Fittings/Pipe-Stub-Ends-Seamless.jpg",
    "./products/Buttweld Fittings/stub-end2.jpg",
    "./products/Buttweld Fittings/stub-end3.jpg",
  ],
  features: [
    "Available in Lap Joint Stub End and Short Stub End types",
    "Size range from 1/2\" NB to 48\" NB (DN15 to DN1200)",
    "Wall thickness from Sch 10 to Sch XXS",
    "Manufactured using seamless, welded, buttweld, and forged processes",
    "Compatible with lap joint flanges for easy disassembly",
    "Complies with ASME B16.9, MSS-SP-75, DIN, EN, ISO, and JIS standards",
    "Surface finishes include black, pickled, sand blasted, polished, and anti-rust coating",
    "Testing includes hydrostatic test, NDT, PMI, and third-party inspection"
  ],
  specs: [
    {
      parameter: "Product Type",
      specification: "Pipe Fitting Stub End (Lap Joint, Short Stub End)",
    },
    {
      parameter: "Size Range",
      specification: "1/2\" NB – 48\" NB (DN15 – DN1200)",
    },
    {
      parameter: "Wall Thickness",
      specification: "Sch 10, 20, 40, 80, 160, XXS",
    },
    {
      parameter: "Standards",
      specification: "ASME B16.9, MSS-SP-75, DIN 2616, EN 10253, ISO 3419, JIS B2312",
    },
    {
      parameter: "Ends",
      specification: "Beveled (BE), Plain (PE), Threaded (NPT/BSP)",
    },
  ],
  productFeatures: [
    "Ensures secure and leak-proof flanged connections",
    "Allows easy disassembly and maintenance of piping systems",
    "High strength and durability under pressure and temperature",
  ...
  applications: [
    ...
    "Construction, HVAC, and shipbuilding industries",
  ...
  21: {
    ...
    shortDescription:
      "High-quality reducing elbows conforming to ANSI B16.28 standard, designed for connecting pipes of different sizes with reliable performance in diverse industrial applications.",
    image:
    ...
    specs: [
      ...
      {
        parameter: "Stainless Steel Grade",
        specification:
          "ASTM A403 WP 304/304L/304H/316/316L/317/317L/321/310/347/904L",
      },
      {
        parameter: "Carbon Steel Grade",
        specification: "ASTM A234 WPB/A420 WPL3/A420 WPL6/MSS-SP-75 WPHY 42-70",
      },
      {
        parameter: "Alloy Steel Grade",
        specification: "ASTM A234 WP1/WP5/WP9/WP11/WP22/WP91",
      },
      {
        parameter: "Nickel Alloy Grade",
        specification:
          "UNS 2200/2201, Monel 400, Alloy 20, Inconel 600/601/625/825, Hastelloy C276",
      },
      {
        parameter: "Duplex & Super Duplex",
        specification: "ASTM A815, ASME SA815 UNS S31803/S32205",
  ...
  22: {
    ...
    shortDescription:
      "Premium ANSI B16.28 stainless steel cross tees manufactured with precision to provide durable, corrosion-resistant, and turbulence-free piping junction solutions.",
    ...
    specs: [
      ...
      },
      {
        parameter: "Nickel Alloy Grades",
        specification:
          "ASTM / ASME SB 336 UNS 2200 (Nickel 200), UNS 2201 (Nickel 201), UNS 4400 (Monel 400), UNS 8020 (Alloy 20 / 20 CB 3), UNS 8825 (Inconel 825), UNS 6600/6601 (Inconel 600/601), UNS 6625 (Inconel 625), UNS 10276 (Hastelloy C 276)",
      },
      {
        parameter: "Duplex & Super Duplex Grades",
        specification:
          "ASTM A815, ASME SA815 UNS S31803, S32205, Werkstoff No. 1.4462",
      },
      {
        parameter: "Copper Nickel Grades",
        specification: "CuNi10Fe1Mn, CuNi30Mn1Fe",
      },
    ],
    productFeatures: [
  ...
  23: {
    ...
    shortDescription:
      "Durable and precision-engineered ANSI B16.28 swage nipples available in concentric and eccentric forms, made with ASTM A403 stainless steel and other premium materials for high-performance piping systems.",
  ...
  29: {
    ...
    shortDescription:
      "High-quality forged concentric reducers compliant with ASTM and ASME standards, designed for smooth pipe size transitions with superior strength, corrosion resistance, and durability.",
    image:
    ...
    specs: [
      {
        parameter: "Stainless Steel Grades",
        specification:
          "ASTM A182, ASTM/ASME SA 358, SA 312 GR TP 304, 304L, 316, 317, 321, 347, 904L",
      },
      {
        parameter: "Duplex & Super Duplex",
        specification:
          "ASTM A182 F51, F53, F55 UNS S31803, S32205, S32550, S32750",
      },
      {
        parameter: "Carbon Steel Grades",
        specification:
          "ASTM/ASME A105, A350 LF2, A53 GR A & B, A106 GR A, B, C, API 5L GR B, X42, X52, X70",
      },
      {
        parameter: "Alloy Steel Grades",
        specification: "ASTM/ASME A182, A335 P1, P5, P9, P11, P22, P23, P91",
      },
      {
        parameter: "Copper Alloy Steel",
        specification: "ASTM/ASME SB111 UNS C10100, C10200, C10300, C10800",
      },
      {
        parameter: "Nickel Alloy Steel",
        specification: "ASTM/ASME SB336, SB564, UNS 2200, 4400, 6600, 10276",
      },
    ],
    productFeatures: [
  ...
  24: {
    ...
    shortDescription:
      "Comprehensive insulation gasket kits designed to provide leak-proof, corrosion-free flange connections and prevent electrolytic or cathodic corrosion in piping systems.",
    image:
    ...
    specs: [
      {
        parameter: "Insulating Material",
        specification: "G-10/G-11 Glass Reinforced Epoxy (GRE)",
      },
      {
        parameter: "Metallic Core",
        specification: "316 Stainless Steel (Duplex & Inconel available)",
      },
      {
        parameter: "Bolt Hole Configuration",
        specification: "Sleeve and washers included for flange bolt insulation",
      },
      {
        parameter: "Temperature Range",
        specification: "-46°C to 200°C (dependent on material)",
      },
      {
        parameter: "Pressure Rating",
        specification: "Compatible with ANSI B16.5 flange classes up to 2500#",
      },
    ],
    productFeatures: [
  ...
  25: {
    ...
    shortDescription:
      "High precision, single ferrule stainless steel reducing unions by Parker featuring robust construction, corrosion resistance, and leak-free performance for instrumentation tubing.",
    ...
    specs: [
      {
        parameter: "Connection Size",
        specification: "3/8 in x 1/2 in (other sizes available)",
      },
      ...
      { parameter: "Maximum Operating Temperature", specification: "1200°F" },
      {
        ...
        specification: "Compression, Single Ferrule",
      },
  ...
  26: {
    ...
    shortDescription:
      "Robust forged and stainless steel tube union elbows manufactured for reliable piping connections, featuring corrosion resistance, dimensional accuracy, and versatile applications across industries.",
    ...
    specs: [
      {
        parameter: "Material",
        specification:
          "Stainless Steel 304, 316, Monel, Brass, Carbon Steel, Alloy Steel, Hastelloy",
      },
      { parameter: "Size Range", specification: '1/16" to 4" BSP/NPT' },
      { parameter: "Angle Types", specification: "45°, 90°, 180°" },
      {
        parameter: "Connection Type",
        specification: "Threaded, Socket Weld, Butt Weld, Compression",
      },
      {
        parameter: "Standards",
        specification: "ISO 8434-1, DIN 2353, DIN EN 3851, ASME B16.11",
      },
    ],
    productFeatures: [
  ...
  27: {
    ...
    shortDescription:
      "Durable, weathering steel panels made with high-performance alloys including copper, nickel, chromium, phosphorus, and manganese. Engineered for exceptional corrosion resistance, strength, and aesthetic patina formation.",
    ...
    specs: [
      {
        parameter: "Material Composition",
        specification:
          "Copper, Nickel, Chromium, Phosphorous, Manganese, Low Carbon Steel Base",
      },
      {
        parameter: "Thickness Range",
        specification: "Typically 1.5 mm to 12 mm (custom sizes available)",
      },
      {
        parameter: "Standard Sizes",
        specification:
          "Plates and Sheets available up to 4800 mm width and 12000 mm length",
      },
      {
        parameter: "Manufacturing Process",
        specification:
          "Alloy blending, rolling, heat treatment, oxidation cycle",
      },
      {
        parameter: "Surface Finish",
        specification: "Natural weathered patina or sandblasted",
      },
  ...
  28: {
    ...
    shortDescription:
      "High-quality forged cross fittings manufactured to ASTM and ASME standards, designed for durable service in piping systems across diverse industries.",
    ...
    specs: [
      {
        parameter: "Stainless Steel Grades",
        specification:
          "ASTM A182, SA 358, SA 312 (304, 304L, 316, 316Ti, 317, 321, 347, 904L)",
      },
      {
        parameter: "Carbon Steel Grades",
        specification:
          "ASTM A105, A350 LF2, A53 GR A&B, A106 GR A, B & C, API 5L GR B & X Series",
      },
      {
        parameter: "Alloy Steel Grades",
        specification: "ASTM A182, ASTM A335 (P1, P5, P9, P11, P22, P91)",
      },
      {
        parameter: "Nickel Alloy Grades",
        specification: "SB 336, SB 564, UNS 2200, 4400, 8825, 6600, 10276",
      },
      {
        parameter: "Duplex & Super Duplex",
        specification: "ASTM A815, SA 815 (S31803, S32205)",
      },
      {
        parameter: "Copper Alloy",
        specification: "SB 111, SB 466 (Cu-Ni 90/10 and 70/30)",
      },
    ],
    productFeatures: [
  ...
  30: {
    ...
    shortDescription:
      "Durable forged cross pipe fittings manufactured to ASTM and ASME standards, designed for high-pressure applications with excellent corrosion resistance and dimensional accuracy.",
    ...
    specs: [
      ...
      {
        parameter: "Alloy Steel Grades",
        specification: "ASTM A182, A335 (P1, P5, P9, P11, P22, P91)",
      },
      {
        parameter: "Nickel Alloy Grades",
        specification: "ASTM SB 336, SB 564, UNS 2200, 4400, 6600, 10276",
      },
      {
        parameter: "Duplex & Super Duplex",
        specification: "ASTM A815, SA815 UNS S31803, S32205",
      },
      {
        parameter: "Copper Alloy Grades",
        specification: "ASTM SB 111, SB 466 (Cu-Ni 90/10, 70/30)",
      },
    ],
    productFeatures: [
  ...
  31: {
    ...
    shortDescription:
      "High quality forged welding outlets manufactured per ANSI B16.9 standards, designed as branch connection fittings providing a reliable 90° outlet with beveled ends for secure welding.",
    ...
    specs: [
      {
        parameter: "Material",
        specification:
          "ASTM A182 Stainless Steel Series, Carbon Steel, Alloy Steel, Duplex Steel",
      },
      { parameter: "Size Range", specification: 'Long sizes from 1/2" to 48"' },
      {
        parameter: "Standards",
        specification: "ANSI B16.9, ASTM A182, MSS-SP-43",
      },
      {
        parameter: "Pressure Rating",
        specification: "As per pipe class ratings",
      },
  ...
  32: {
    ...
    shortDescription:
      "High-quality forged nipple outlets manufactured to ASTM A182 and ASME standards, providing reliable branch connection points with threaded or plain ends for various industrial applications.",
    ...
    specs: [
      {
        parameter: "Material Composition",
        specification:
          "Stainless Steel, Carbon Steel, Alloy Steel, Duplex & Super Duplex Steel",
      },
      { parameter: "Size Range", specification: '1/4" NB to 4" NB' },
      {
        parameter: "Standards",
        specification: "ASTM A182, ASME SA182, ANSI B16.11",
      },
    ],
    productFeatures: [
  ...
  33: {
    ...
    shortDescription:
      "Precision forged ASTM A182 nipple outlets suitable for high-performance piping systems, made from stainless steel, alloy steel, carbon steel, and duplex grades ensuring corrosion resistance and durability.",
  ...
  34: {
    ...
    shortDescription:
      "Premium ASTM A182 flange outlets manufactured with superior corrosion resistance and mechanical strength for high-pressure and high-temperature industrial piping applications.",
    ...
    specs: [
      ...
      { parameter: "Pressure Ratings", specification: "Class 150 to 2500#" },
      {
        parameter: "Finish",
        specification:
          "Polished, Black, Bright, others as per client requirements",
      },
    ],
    productFeatures: [
  ...
  35: {
    ...
    shortDescription:
      "High-quality ASTM A182 threaded outlets manufactured for seamless pipe branch connections without welding, featuring corrosion resistance, durability, and precision threading.",
    ...
    specs: [
      ...
      {
        parameter: "Standards",
        specification: "ASTM A182, ANSI B16.11, MSS SP-43",
      },
      {
        parameter: "Material Types",
        specification: "Stainless, Carbon, Alloy, Duplex Stainless Steels",
      },
    ],
    productFeatures: [
      "ISO 9001:2015 certified manufacturing",
  ...
  36: {
    ...
    shortDescription:
      "Precision forged ASTM A182 elbow outlets designed for reliable branch connections in piping systems, featuring high corrosion resistance, dimensional accuracy, and robustness for demanding industrial environments.",
    ...
    specs: [
      ...
      {
        parameter: "Pressure Classes",
        specification: "2000, 3000, 6000, 9000 LBS",
      },
      {
        parameter: "Standards",
        specification: "ANSI/ASME B16.9, MSS SP-97, BS 3799",
      },
    ],
    productFeatures: [
  ...
  37: {
    ...
    shortDescription:
      "Durable ASTM A234 WP11 pipe reducing tees manufactured to ASME B16.9 standards, designed for smooth flow transitions with excellent corrosion resistance and high mechanical strength.",
    image:
    ...
    specs: [
      {
        parameter: "Standards",
        specification: "ASME B16.9, MSS-SP-43, ASTM A234 WP11",
      },
  ...
  38: {
    ...
    shortDescription:
      "High strength ASTM A325 hex bolts with six-sided heads, designed for structural applications and manufactured in a variety of grades, materials, and corrosion-resistant finishes.",
    ...
    specs: [
      {
        parameter: "Material Grades",
        specification:
          "Stainless Steel (AISI 302, 304, 316, 310, 321, 410, 420, 904L, etc.), Duplex Steel (UNS S31803, S32205, S32750, etc.), Carbon Steel (A325, A307, A193), Alloy Steel (A193/B7/B7M/B16), Nickel Alloys (Monel 400, Inconel 600, 625, Hastelloy C276, Alloy 20)",
      },
      {
        parameter: "Available Size",
        specification:
          '1/2"–1-1/2" (imperial), M12–M36 (metric); Custom sizes upto 4"',
      },
      {
        parameter: "Length Range",
        specification:
          '1/2"–10" (imperial), 3 mm–200 mm (metric), longer on request',
      },
      { parameter: "Finish", specification: "Plain, Galvanized, Custom" },
      {
        parameter: "Head Dimensions",
        specification:
          'ASME B18.2.6 Heavy Hex; width across flats 7/8"–2-3/8" depending on diameter',
      },
      {
        parameter: "Thread Form",
        specification: "UNC, UNF, BSW, Metric, other international forms",
      },
    ],
    productFeatures: [
  ...
  39: {
    ...
    shortDescription:
      "High strength ASTM A325 heavy hex nuts manufactured to ASME B18.2.6 dimensions, designed for structural bolting with enhanced thickness, larger head, and compatibility with heavy hex bolts.",
    ...
    specs: [
      {
        parameter: "Thread Size",
        specification: '1/2" to 1-1/2" (UNC, UNF), M12–M36 metric',
      },
      {
        parameter: "Width Across Flats",
        specification: '7/8" to 2-3/8" (imperial)',
      },
      {
        parameter: "Height (Basic)",
        specification: '31⁄64" to 1 15⁄32" (per ASME B18.2.6)',
      },
      {
        parameter: "Material/Grades",
        specification:
          "AISI 302, 304, 316, 317, 321, 410, 904L, Duplex, ASTM A307, A193/B6/B7, A563, A194, etc.",
      },
      {
        parameter: "Tensile Strength",
        specification:
          "Min. matches compatible heavy hex bolts (A325: ~120 ksi)",
      },
    ],
    productFeatures: [
  ...
  40: {
    ...
    shortDescription:
      "High-strength ASTM A193 B7 alloy steel stud bolts, fully threaded with nuts on both ends, heat-treated for mechanical integrity in high-temperature and high-pressure industrial applications.",
    ...
    specs: [
      {
        ...
        specification: "¼” to 8” (inch), M6–M152 (metric); custom sizes",
      },
      {
        parameter: "Thread Type",
        specification: "UNC, UNF, Metric, BSW, BSF, ISO, DIN",
      },
      {
        parameter: "Operating Temperature",
        specification: "Up to 840°C for ASTM A193 B7",
      },
      {
        parameter: "Tensile Strength",
        specification: "≥125 ksi (B7), ≥100 ksi (B7M)",
      },
  ...
  41: {
    ...
    shortDescription:
      "Precision-engineered ASTM A325 washers, including flat, lock, spring, square, and fender types, designed to distribute loads, prevent loosening, and protect surfaces in structural assemblies and fastener applications.",
    ...
    specs: [
      {
        ...
        specification:
          "Bolt size 1/4” to 1-1/2” (imperial), M3–M56 (metric); Custom sizes per order",
      },
      {
        parameter: "Thickness Range",
        specification: "1/32” to 3/16” standard, custom on request",
      },
      {
        parameter: "Finish",
        specification: "Plain, zinc plated, galvanized, PTFE, special coatings",
      },
      {
        parameter: "Shape",
        specification: "Flat, Square, Round, Spring, Fender, Ogee, Beveled",
      },
    ],
    productFeatures: [
  ...
  42: {
    ...
    shortDescription:
      "High-strength anchor and foundation bolts manufactured to ASTM, DIN, and ISO standards, designed to securely affix structures to concrete or masonry in demanding industrial environments.",
    ...
    specs: [
      {
        parameter: "Material Grades",
        specification:
          "Stainless Steel (AISI 302, 304, 316, 321, 347, 904L, etc.), Duplex Super Duplex (ASTM A815 UNS S31803, S32750, etc.), Carbon Steel (A307, A193), Alloy Steel (A193 B6/B7), Nickel Alloys (Monel, Inconel, Hastelloy, Alloy 20), Titanium",
      },
      {
        parameter: "Tensile Strength",
        specification: "≥125 ksi (A193 B7), custom per order",
      },
      {
        parameter: "Operating Temperature",
        specification: "Up to 840°C for A193 B7",
      },
      {
        parameter: "Certifications",
        specification: "ISO 9001:2015, EN 10204/3.1, NACE, PED, as requested",
      },
    ],
    productFeatures: [
  ...
  43: {
    ...
    shortDescription:
      "Industrial grade ASTM A325 eye bolts manufactured with precision for lifting, securing, and rigging applications, made from stainless steel, alloy, carbon steel, and nickel alloys for superior strength and corrosion resistance.",
    ...
    specs: [
      ...
      {
        parameter: "Type",
        specification: "Stud Bolts, Forged Bolts, Screwed Bolts",
      },
    ],
    productFeatures: [
      "Excellent corrosion resistance",
  ...
  44: {
    ...
    shortDescription:
      "High-strength ASTM A325 fasteners designed for structural applications, manufactured to meet international standards with excellent mechanical properties, corrosion resistance, and durability.",
    ...
    specs: [
      {
        parameter: "Tensile Strength",
        specification:
          'Minimum 120 ksi (sizes ≤ 1"), 105 ksi (sizes > 1" to 1.5")',
      },
      {
        parameter: "Thread Forms",
        specification: "UNC, UNF, Metric coarse/fine",
      },
      { parameter: "Finish", specification: "Plain, galvanized, coated" },
      {
        parameter: "Types",
        specification: "Hex bolts, studs, nuts, washers, anchor bolts",
      },
    ],
    productFeatures: [
  ...
  45: {
    ...
    shortDescription:
      "High-quality ASTM A325 U Bolts manufactured for structural fastening and support applications, available in stainless steel, carbon steel, alloy steel, and nickel alloys, designed for durability and corrosion resistance.",
    ...
    specs: [
      {
        parameter: "Diameter Range",
        specification: "6 mm to 60 mm (as standard)",
      },
      { parameter: "Length Range", specification: "Up to 200 mm or custom" },
      {
        parameter: "Certification",
        specification: "ISO 9001:2015, EN 10204/3.1, NACE",
      },
    ],
    productFeatures: [
      "High tensile strength and corrosion resistance",
  ...
  46: {
    ...
    shortDescription:
      "Durable V-shaped refractory anchors made from stainless steel, high nickel alloys like Inconel and Incoloy, designed to support refractory linings in high-temperature industrial furnaces and chemical plants.",
    ...
    specs: [
      {
        parameter: "Material Grades",
        specification:
          "SS 304, 304L, 310, 310S, 316, 316L, 321, 347, 904L; Inconel 600, 800 series; Monel 400; Hastelloy C276; Incoloy 800/800HT",
      },
      { parameter: "Thickness Range", specification: "3 mm to 12 mm" },
      {
        parameter: "Typical Sizes",
        specification: "Custom as per client requirements",
      },
      {
        parameter: "Testing",
        specification:
          "Radiography, macro & micro testing, mechanical and chemical tests",
      },
    ],
    productFeatures: [
  ...
  47: {
    ...
    shortDescription:
      "Robust Y-shaped refractory anchors made from stainless steel grades including 304, 304L, 316, 316L, 310, 321, 347, designed for high temperature and high pressure industrial applications, retaining castable and brick linings.",
    image:
    ...
    specs: [
      {
        parameter: "Shape",
        specification: "Y-shaped for enhanced refractory lining support",
      },
      {
        parameter: "Material Grades",
        specification:
          "Stainless Steel 304, 316, 310; Inconel 600, 800 series; Monel 400",
      },
  ...
  48: {
    ...
    shortDescription:
      "Durable U-shaped refractory anchors manufactured from stainless steel and high nickel alloys like Incoloy 800, 800H, 800HT, Inconel 600, and Monel 400, designed for supporting refractory linings in industrial furnaces and chemical reactors.",
    ...
    specs: [
      {
        parameter: "Material Grades",
        specification:
          "Stainless Steel 304, 304L, 316, 316L, 310, 310S; Inconel 600, 800 series; Monel 400; Incoloy 800/800H/800HT",
      },
      {
        parameter: "Typical Thickness",
        specification: "2 to 12 mm depending on application",
      },
      {
        parameter: "Custom Sizes",
        specification: "Available as per customer drawings",
      },
    ],
    productFeatures: [
  ...
  49: {
    ...
    shortDescription:
      "Customized refractory anchors made from high-grade stainless steel such as 304, 304L, 316, 316L, 321, suitable for supporting various refractory linings in high-temperature industrial applications including chemical and power plants.",
    image:
    ...
    specs: [
      {
        ...
        specification:
          "Stainless Steel 304/304L/316/316L/321/347/310, and high nickel alloys",
      },
      {
        parameter: "Customization",
        specification:
          "Fully customizable sizes and shapes per client requirements",
      },
      {
        parameter: "Thickness Range",
        specification: "Typically 3 mm to 12 mm or per client design",
      },
    ],
    productFeatures: [
  ...
  50: {
    ...
    shortDescription:
      "Robust carbon steel forged rings manufactured from ASTM A105 grade steel, offering high tensile strength, corrosion resistance, and suitability for industrial furnaces, thermal processing, and steel production centers.",
    image:
    ...
    specs: [
      {
        ...
        specification:
          "Max Carbon 0.35%, Manganese 0.6-1.05%, Phosphorus max 0.035%, Sulfur max 0.04%, Silicon 0.1-0.35%, Copper max 0.4%, Nickel max 0.4%, Chromium max 0.3%, Molybdenum max 0.12%, Vanadium max 0.08%",
      },
      {
        parameter: "Mechanical Properties",
        specification:
          "Tensile Strength min. 485 MPa (70 ksi), Yield Strength min. 250 MPa (36 ksi), Elongation min. 30%, Hardness max. 187 HBW",
      },
      {
        parameter: "Manufacturing Process",
        specification:
          "Hot forging at 1700-2200°F followed by quenching and tempering or normalizing",
      },
      {
        parameter: "Testing",
        specification:
          "Ultrasonic testing, hardness test, tensile and elongation tests",
      },
    ],
    productFeatures: [
  ...
  51: {
    ...
    shortDescription:
      "Heavy-duty rotor shafts manufactured from ASTM A105 carbon steel, stainless steel grades (304, 304L, 316, 316L, 321, 347, 904L), and alloy steel grades F22, EN8, designed for power generation, chemical, and industrial applications.",
    ...
    specs: [
      {
        parameter: "Diameter Range",
        specification: "Up to 550 mm OD or per customer specs",
      },
      {
        parameter: "Length Range",
        specification: "Custom lengths as per application",
      },
      {
        parameter: "Surface Finish",
        specification: "Bright polished, black, or custom finishes",
      },
      {
        parameter: "Standards",
        specification: "ASTM A105, A350, EN8, EN9, ASTM A182",
      },
    ],
    productFeatures: [
  ...
  52: {
    ...
    shortDescription:
      "Premium stainless steel and carbon steel propeller shafts and forged round bars manufactured to precise dimensions, offering high corrosion resistance, mechanical strength, and versatility for marine, industrial and structural applications.",
    ...
    specs: [
      {
        parameter: "Diameter Range",
        specification:
          "2 mm to 1800 mm (round bars); up to 24 inches (propeller shafts)",
      },
      {
        parameter: "Length Range",
        specification: "Customized lengths as per application",
      },
      {
        parameter: "Material Standards",
        specification:
          "ASTM A105/A350, EN8/EN9, ASTM A182 for stainless/alloy, ASTM B435/B445 for Nickel alloys",
      },
      {
        parameter: "Surface Finish",
        specification: "Polished, black, zinc plated, custom finishes",
      },
    ],
    productFeatures: [
  ...
  53: {
    ...
    shortDescription:
      "Precision-engineered custom forgings manufactured from stainless steel (304, 304L, 316, 316L, 321, 347, 904L) and carbon steel (A105, A350, EN8, EN9) for diverse industrial applications including automotive, oil & gas, and chemical processing.",
    image:
    ...
    specs: [
      {
        parameter: "Forging Types",
        specification:
          "Open Die Forging, Closed Die Forging, Cold Forging, Ring Rolling",
      },
      {
        parameter: "Weight Range",
        specification:
          "From 200 grams to 30 kilograms or as per product requirements",
      },
      {
        parameter: "Material Selection",
        specification:
          "Based on mechanical and corrosion resistance requirements",
      },
      {
        parameter: "Customization",
        specification:
          "Full customization of geometry, size, and surface finish",
      },
    ],
    productFeatures: [
  ...
  54: {
    ...
    slug: "stainless-steel-insulation-gasket-kits",
    shortDescription:
      "Complete insulation gasket kits made from high-grade stainless steel such as SS 304, 304L, 316, 316L, 321, 347, and 904L, designed to electrically isolate flanged connections and prevent galvanic corrosion in piping systems.",
    image:
    ...
    specs: [
      {
        parameter: "Maximum Pressure Class",
        specification: "API 15,000 psi / ANSI 2500#",
      },
      {
        parameter: "Materials",
        specification:
          "316/316L stainless steel cores, Inconel alloy options, Phenolic/G10/G11 laminates",
      },
  ...
  55: {
    ...
    shortDescription:
      "Durable spiral wound gaskets constructed by spirally winding metallic strips with soft fillers, available in stainless steel and high nickel alloys, suitable for fluctuating pressures and temperatures in industrial piping and refinery applications.",
    ...
    specs: [
      {
        parameter: "Standard Sizes",
        specification: "Custom sizes up to 48 inches diameter",
      },
      {
        parameter: "Pressure Classes",
        specification: "Up to ANSI 2500#, API 15,000 psi",
      },
      {
        parameter: "Material Standards",
        specification: "ASTM, ASME, DIN, ISO, BS",
      },
      {
        parameter: "Dielectric Properties",
        specification:
          "Corrosion resistant with excellent sealing capabilities",
      },
    ],
    productFeatures: [
  ...
  56: {
    ...
    shortDescription:
      "Precision-engineered alloy 20 and stainless steel ring type joint (RTJ) gaskets designed for high temperature and high pressure applications, widely used in oilfields, petrochemical, and refinery industries for leak-proof flanged connections.",
    image:
    ...
    specs: [
      {
        parameter: "Profiles",
        specification: "Oval and Octagonal cross sections",
      },
      {
        parameter: "Material Hardness",
        specification:
          "Typically Rockwell B scale max 83-90, softer than flange",
      },
      {
        parameter: "Pressure Rating",
        specification: "Up to 20,000 psi depending on design",
      },
  ...
  57: {
    ...
    shortDescription:
      "High-performance octagonal ring type joint gaskets manufactured from stainless steel (316, 316L, 321, 347, 904L) and high-grade nickel alloys (Monel 400, K500, Inconel 600, 625), designed for robust sealing in high-pressure, high-temperature industrial applications.",
    ...
    specs: [
      { parameter: "Ring Numbers", specification: "R11 to R105" },
      {
        parameter: "Material Hardness",
        specification:
          "Softer than flange material, typically Rockwell B scale max 83-90",
      },
      {
        parameter: "Size Range",
        specification: '1/2" to 24" nominal diameter',
      },
      {
        parameter: "Temperature Range",
        specification: "Up to 1000°F and above depending on material",
      },
    ],
    productFeatures: [
  ...
  58: {
    ...
    shortDescription:
      "High-quality graphite filler gaskets featuring stainless steel facings, designed for superior sealing in high-temperature and high-pressure applications, widely used in petrochemical, pharmaceutical, and power industries.",
    image:
    ...
    specs: [
      {
        parameter: "Temperature Range",
        specification: "-250°C to +650°C (variable by material)",
      },
      {
        parameter: "Pressure Ratings",
        specification: "Up to 15000 psi (API 6A) / ANSI 2500# and above",
      },
      {
        parameter: "Material Standards",
        specification: "ASTM, ASME B16.20, API, DIN, ISO compliant",
      },
      {
        parameter: "Thickness Range",
        specification: "Typically 3.2 mm to 6.4 mm or customized",
      },
    ],
    productFeatures: [
  ...
  59: {
    ...
    shortDescription:
      "Premium stainless steel designer sheets with diverse finishes including gold mirror, gold hairline, etching, and black hairline, manufactured from grade 304 stainless steel and available in custom sizes and thicknesses.",
    ...
    specs: [
      {
        parameter: "Size",
        specification: "8 ft x 4 ft standard; custom sizes available",
      },
  ...
  60: {
    ...
    slug: "corten-steel-panels",
    shortDescription:
      "Durable Corten steel panels made from weathering steel alloys containing copper, nickel, chromium, phosphorus, and manganese, noted for outstanding corrosion resistance, strength, and natural protective rust patina formation.",
  ...
  61: {
    ...
    shortDescription:
      "High-quality stainless steel profiles in T, U, and C shapes including Grade 304 with PVD titanium coating, gold and black mirror finishes, ideal for architectural, construction, and decorative applications.",
    image:
    ...
    specs: [
      {
        ...
        specification: "T, U, C shaped structural and decorative profiles",
      },
      {
        parameter: "Material",
        specification: "Stainless Steel 304, 304L, with PVD coatings",
      },
      {
        parameter: "Size",
        specification:
          "Custom sizes available, standard sheets typically 8 ft x 4 ft",
      },
      {
        parameter: "Thickness Range",
        specification: "0.3 mm to 3 mm or customized",
      },
    ],
    productFeatures: [
  ...
  62: {
    ...
    shortDescription:
      "High-end stainless steel profiles coated using Physical Vapor Deposition (PVD) titanium ion plating to provide superior wear, scratch, and corrosion resistance, available in multiple colors and finishes for architectural and decorative applications.",
    image:
    ...
    specs: [
      {
        parameter: "Profile Types",
        specification: "T, U, L, J, M, Z, S, W, Q and custom profiles",
      },
      {
        parameter: "Grade",
        specification: "Stainless Steel 304/316, PVD Coated",
      },
      {
        parameter: "Thickness",
        specification: "0.6 mm to 1 mm standard; custom available",
      },
  ...
  63: {
    ...
    shortDescription:
      "High-quality stainless steel omega profiles manufactured from SS 304, 316, and aluminum, available in various sizes, thicknesses, and decorative finishes including mirror, hairline, gold, and rose gold coatings, used in architectural and structural applications.",
    ...
    specs: [
      {
        parameter: "Material Grade",
        specification: "SS 304, 316, Aluminum 6063 T6",
      },
      {
        parameter: "Thickness Range",
        specification: "0.8 mm, 1.0 mm, 1.2 mm, customizable",
      },
      {
        parameter: "Length Range",
        specification: "2438 mm to 3050 mm (standard), customizable lengths",
      },
      {
        parameter: "Surface Finish",
        specification:
          "Mirror, Hairline, Gold, Rose Gold, Black, Champagne, Bronze",
      },
    ],
    productFeatures: [
  ...
  64: {
    ...
    shortDescription:
      "Durable and weather-resistant Corten steel planters made from weathering steel alloys containing copper, nickel, chromium, phosphorus, and manganese, naturally forming a protective rust layer that ensures long life and low maintenance.",
    ...
    specs: [
      {
        parameter: "Sizes (Standard Examples)",
        specification:
          "Square: 16x16x16 inches, 20x20x20 inches; Rectangular: 40x40x14 inches, 48x48x16 inches",
      },
      {
        parameter: "Material Thickness",
        specification: "Standard: 2 mm; Options: 2-5 mm",
      },
      {
        parameter: "Drainage",
        specification: "Optional drainage holes of 27 mm diameter",
      },
      {
        parameter: "Finish",
        specification: "Naturally rusted patina or accelerated rust finish",
      },
    ],
    productFeatures: [
  ...
  65: {
    ...
    shortDescription:
      "High-performance metal sheets, plates, and coils used in a range of industries, manufactured with ASTM- and IS-certified grades for superior durability, corrosion resistance, and versatility in shape and size.",
  ...
  66: {
    ...
    shortDescription:
      "High-performance rods, bars, and wires available in a range of nickel alloys, stainless steel, carbon steel, brass, bronze, and other high-grade materials for industrial and structural applications.",
    image: "./images/RODS_BARS/Rods.jpg",
    gallery: ["./images/RODS_BARS/bars.jpg", "./images/RODS_BARS/Rods.jpg"],
    features: [
  ...
  67: {
    ...
    slug: "copper-tubes",
    shortDescription:
      "High-quality copper materials including DHP, ETP, DPA, and OFHC grades designed for superior electrical and thermal conductivity in industrial and architectural applications.",
    ...
    specs: [
      ...
      {
        parameter: "Length",
        specification: "Up to 10 meters straight, coils up to 25 meters",
      },
      {
        parameter: "Standard",
        specification: "ASTM / ISS / BSS / Custom specification",
      },
    ],
    productFeatures: [
  ...
  68: {
    ...
    slug: "brass-tubes",
    shortDescription:
      "Durable and versatile brass products available in various compositions and mechanical strengths, ideal for decorative, electrical, and structural uses.",
    ...
    specs: [
      {
        parameter: "Material Grades",
        specification: "63/37, 70/30, Admiralty, Aluminium Brass",
      },
      {
        parameter: "Diameter",
        specification: "Up to 160mm for rods and tubes",
      },
  ...
  69: {
    ...
    slug: "cupronickel",
    shortDescription:
      "High-strength Cupronickel alloys with superior resistance to seawater corrosion, ideal for marine, chemical, and condenser tube applications.",
  ...
  70: {
    ...
    slug: "bronzes",
    shortDescription:
      "High-performance bronze alloys including phosphorous and aluminium bronze, offering superior strength, wear resistance, and corrosion protection.",
  ...
  71: {
    ...
    shortDescription:
      "Copper tubes, rods, profiles, and wires precision-engineered for high conductivity, corrosion resistance, and pressure handling in critical systems.",
    ...
    specs: [
      ...
      {
        parameter: "Testing",
        specification: "Chemical, Hardness, Hydrostatic, NDT (Eddy Current)",
      },
    ],
    productFeatures: [
  ...
  72: {
    ...
    slug: "cap",
    shortDescription:
      "A pipe fitting used to seal the end of a pipe, providing leak-proof closure and protection from contamination in piping systems.",
    image: "./products/Buttweld Fittings/cap.jpg",
    gallery: [
      "./products/Buttweld Fittings/pipe_cap1.jpg",
      "./products/Buttweld Fittings/pipe_cap2.png",
    ],
    features: [
      "Available in End Cap and Flush Cap types",
      'Size range from 1/2" NB to 48" NB (DN15 to DN1200)',
      "Wall thickness from Sch 10 to Sch XXS",
      "Manufactured using seamless, welded, buttweld, and forged processes",
      "Available in stainless steel, carbon steel, alloy steel, duplex, and nickel alloys",
      "Complies with ASME B16.9, DIN, EN, ISO, and JIS standards",
      "Surface finishes include black, pickled, sand blasted, polished, and anti-rust coating",
      "Testing includes hydrostatic test, NDT, PMI, and third-party inspection",
    ],
    specs: [
      {
        parameter: "Product Type",
        specification: "Pipe Fitting Cap (End Cap, Flush Cap)",
      },
      {
        parameter: "Size Range",
        specification: '1/2" NB – 48" NB (DN15 – DN1200)',
      ...
      },
      {
        parameter: "Standards",
        specification:
          "ASME B16.9, MSS-SP-75, DIN 2616, EN 10253, ISO 3419, JIS B2312",
      },
      {
        parameter: "Ends",
        specification: "Beveled (BE), Plain (PE), Threaded (NPT/BSP)",
    ...
    productFeatures: [
      "Leak-proof closure ensures no leakage from pipe ends",
      "High strength and durability under extreme pressure and temperature",
      "Excellent corrosion resistance for long service life",
      "Easy installation with versatile end connections",
      "Manufactured as per international standards for reliability",
    ],
    applications: [
      "Oil & Gas and petrochemical industries",
      "Chemical processing and power generation",
...
function ProductDetails() {
  ...
  useEffect(() => {
    ...
    if (urlParam) {
      ...
      if (!match) {
        match = allDbProducts.find((dbItem) => {
          const dbSlugTokens = (dbItem.slug || "")
            .toLowerCase()
            .split(/[^a-z0-9]+/)
            .filter(Boolean);
          const dbNameTokens = (dbItem.name || "")
            .toLowerCase()
            .split(/[^a-z0-9]+/)
            .filter(Boolean);

          const matchesAllSlugTokens =
            searchTokens.length > 0 &&
            searchTokens.every((token) => dbSlugTokens.includes(token));
          const matchesAllNameTokens =
            searchTokens.length > 0 &&
            searchTokens.every((token) => dbNameTokens.includes(token));
      ...
      if (!match) {
        match = allDbProducts.find((dbItem) => {
          ...
          return (
            (normDbSlug &&
              (normDbSlug.includes(normSearch) ||
                normSearch.includes(normDbSlug) ||
                normDbSlug.startsWith(normSearch))) ||
            (normDbName &&
              (normDbName.includes(normSearch) ||
                normSearch.includes(normDbName) ||
                normDbName.startsWith(normSearch)))
          );
        });
      }
  ...
  if (!product && !isLoading) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center bg-white px-4">
        <h2 className="text-3xl font-bold text-[#06367b] mb-4">
          Product Not Found
        </h2>
        <p className="text-gray-500 mb-8">
          We couldn't find the details for this product.
        </p>
        <a
          href="/products"
          className="bg-gradient-to-r from-[#06367b] to-[#2EC4FF] text-white px-8 py-3 rounded-full font-bold shadow-lg"
        >
          Browse All Products
        </a>
      </div>
    ...
    <div className="bg-[#ffffff] min-h-screen pt-24 pb-24 font-sans relative overflow-hidden">
      ...
      <div className="max-w-[1350px] mx-auto px-4 md:px-[5%]">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start mb-16">
          ...
          <div
            className="w-full lg:w-[45%] shrink-0 animate-fade-up"
          ...
          <div
            className="w-full lg:w-[55%] flex flex-col pt-2 lg:pt-6 animate-fade-up"
        ...
        <div className="w-full">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6">
                {(product.features || product.keySpecs).map((feature, i) => (
                  <div
                    key={i}
                    className="flex items-start gap-4 bg-white p-5 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-50 hover:shadow-[0_8px_30px_rgba(6,54,123,0.08)] transition-all"
                  >
                    <div className="mt-0.5 shrink-0">
                      <PremiumBulletIcon />
                    </div>
                    <span
                      className="text-gray-700 font-medium tracking-wide text-[15px] leading-relaxed"
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-2 border-l-4 border-blue-50 pl-2">
                {(product.specs || product.technicalSpecs).map((spec, i) => (
                  <div
                    key={i}
                    className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-4 py-4 border-b border-gray-100 px-2 hover:bg-gray-50/50 rounded-lg transition-colors"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-8">
                {product.productFeatures.map((highlight, i) => (
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <span
                      className="text-gray-700 leading-relaxed tracking-wide font-medium text-[15px]"
          ...
          <div
            className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16 animate-fade-up"
          ...
          >
              ...
              <div className="bg-gray-50 rounded-[1.5rem] p-8 border border-gray-100">
                ...
                <div className="flex flex-wrap gap-3">
                  {product.applications.map((app, i) => (
                    <span
                      key={i}
                      className="bg-white text-gray-700 text-[13px] font-bold px-4 py-2.5 rounded-full shadow-sm border border-gray-100 tracking-wider"
                    >
                      {app}
                    </span>
                  ))}
            ...
            {(product.exportRegions || product.exportCountries) && (
              <div className="bg-gray-50 rounded-[1.5rem] p-8 border border-gray-100">
                ...
                <div className="flex flex-wrap gap-3">
                  {(product.exportRegions || product.exportCountries).map(
                    (region, i) => (
                      <span
                        key={i}
                        className="bg-[#EAF4FF] text-[#06367b] text-[13px] font-bold px-4 py-2.5 rounded-full shadow-sm border border-[#2EC4FF]/20 tracking-wider"
                      >
                        {region}
                      </span>
                    ),
          ...
          {product.otherTypes && (
            <div
              className="mt-10 pt-10 border-t border-gray-100 animate-fade-up"
            ...
            >
              ...
              <div className="flex flex-wrap gap-2.5">
                {product.otherTypes.map((type, i) => (
                  <span
                    key={i}
                    className="bg-white text-gray-500 text-[13px] font-medium px-4 py-2 rounded-md border border-gray-200 tracking-wide hover:border-gray-300 transition-colors cursor-default"
                  >
                    {type}
                  </span>
                ))}
      ...
      {isGalleryOpen && product.gallery && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 md:p-8">
          <div
            className="bg-white rounded-xl shadow-2xl w-full max-w-5xl flex flex-col overflow-hidden max-h-[90vh] animate-fade-up"
